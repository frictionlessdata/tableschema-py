...
@pytest.mark.parametrize('format, value, options, result', [
    ...
    ('default', '100%', {'bareNumber': False}, Decimal(100)),
    ('default', '1000‰', {'bareNumber': False}, Decimal(1000)),
    ...
    ('default', '10,000.00', {'groupChar': ',', 'bareNumber': False}, Decimal(10000)),
    ('default', '10,000,000.00', {'groupChar': ',', 'bareNumber': False}, Decimal(10000000)),
    ('default', '$10000.00', {'bareNumber': False}, Decimal(10000)),
    ('default', '  10,000.00 €', {'groupChar': ',', 'bareNumber': False}, Decimal(10000)),
    ('default', '10 000,00', {'groupChar': ' ', 'decimalChar': ','}, Decimal(10000)),
    ('default', '10 000 000,00', {'groupChar': ' ', 'decimalChar': ','}, Decimal(10000000)),
    ('default', '10000,00 ₪', {'groupChar': ' ', 'decimalChar': ',', 'bareNumber': False}, Decimal(10000)),
    ('default', '  10 000,00 £', {'groupChar': ' ', 'decimalChar': ',', 'bareNumber': False}, Decimal(10000)),
