...
@pytest.mark.parametrize('format, value, options, result', [
    ...
    ('default', '10,000.00', {}, Decimal(10000)),
    ('default', '10,000,000.50', {}, Decimal(10000000.5)),
    ('default', '10.50', {}, Decimal(10.5)),
    ('default', '1,000', {}, Decimal(1000)),
    ('default', '100%', {}, Decimal(100)),
    ...
    ('default', '10,000.00', {'currency': True}, Decimal(10000)),
    ('default', '10,000,000.00', {'currency': True}, Decimal(10000000)),
